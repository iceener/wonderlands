...
import type {
  CreateInteractionUsageInput,
  ThreadInteractionBudgetSnapshot,
  UsageLedgerRepository,
} from '../../../../domain/ai/usage-ledger-repository'
...
export const createUsageLedgerRepository = (db: RepositoryDatabase): UsageLedgerRepository => ({
