...
const toRecord = (row: typeof mcpOauthCredentials.$inferSelect): McpOauthCredentialRecord => ({
  ...
  discoveryStateJson: row.discoveryStateJson as McpOauthDiscoveryStateJson | null,
  id: row.id,
...
export const createMcpOauthCredentialRepository = (
