...
import type {
  CreateSandboxExecutionPackageInput,
  SandboxExecutionPackageRecord,
  SandboxExecutionPackageRepository,
  UpdateSandboxExecutionPackageInput,
...
export const createSandboxExecutionPackageRepository = (
  ...
  create: (
    ...
    try {
      ...
      db.insert(sandboxExecutionPackages)
        .values({ ...record })
        .run()
