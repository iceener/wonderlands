...
import type {
  ClaimRunInput,
  HeartbeatRunClaimInput,
  ReleaseRunClaimInput,
  RunClaimRecord,
  RunClaimRepository,
} from '../../../../domain/runtime/run-claim-repository'
import type { DomainError } from '../../../../shared/errors'
import { asRunId, asTenantId } from '../../../../shared/ids'
...
export const createRunClaimRepository = (db: RepositoryDatabase): RunClaimRepository => ({
