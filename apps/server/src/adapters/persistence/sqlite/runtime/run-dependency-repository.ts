...
import type {
  CreateRunDependencyInput,
  ResolveManyRunDependenciesForRunInput,
  ResolveRunDependencyInput,
  RunDependencyRecord,
  RunDependencyRepository,
} from '../../../../domain/runtime/run-dependency-repository'
import type { DomainError } from '../../../../shared/errors'
import { asRunId, asTenantId, type RunId } from '../../../../shared/ids'
...
export const createRunDependencyRepository = (db: RepositoryDatabase): RunDependencyRepository => {
  const getById = (
    scope: TenantScope,
    dependencyId: string,
