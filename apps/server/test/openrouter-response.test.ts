...
contractCase(
  'OpenRouter response normalization falls back to assistant message text when outputText is missing',
  () => {
    const response = {
...
contractCase(
  'OpenRouter response normalization fails explicitly on unsupported output item types',
  () => {
    const response = {
      completedAt: 0,
      createdAt: 0,
...
contractCase(
  'OpenRouter response normalization fails explicitly on unsupported message annotations',
  () => {
    const response = {
      completedAt: 0,
      createdAt: 0,
...
test('OpenRouter response normalization contract matrix', () => {
