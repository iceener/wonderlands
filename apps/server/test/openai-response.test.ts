...
contractCase(
  'OpenAI response normalization preserves aggregated web search activity and citations',
  () => {
    const response = {
      id: 'resp_openai_1',
      model: 'gpt-5.4',
...
contractCase(
  'OpenAI response normalization preserves separate web search calls per output item id',
  () => {
    const response = {
      id: 'resp_openai_2',
      model: 'gpt-5.4',
...
contractCase(
  'OpenAI response normalization fails explicitly on unsupported output item types',
  () => {
    const response = {
...
contractCase(
  'OpenAI response normalization fails explicitly on unsupported message annotations',
  () => {
    const response = {
...
test('OpenAI response normalization contract matrix', () => {
